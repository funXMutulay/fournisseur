...
<form:form action="saveFournisseur" method="post" modelAttribute="fournisseur">
<table>

<tr><td>ID FOURNISSEUR:</td> <td><form:input type="text" path="fournisseurId"/></td></tr> 
...
<a href="displayClients">AFFICHER LES FOURNISSEURS</a>
